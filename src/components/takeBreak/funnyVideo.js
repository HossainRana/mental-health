        ...
        <>
            ...
            <section>
              <Card style={{border: 'none'}}>
                <h3 style={{textAlign: 'left', color: 'green', fontFamily: 'initial'}}>Funny Videos</h3>
                  <Card.Body>
                    <Card.Text>
                      <Row>
                        <ul>
                         <div style={{display: 'flex', listStyleType: 'none', marginBottom: '10px'}}>
                            <FontAwesomeIcon icon={faVideo} style={{color:'green', marginRight:'10px'}}/><p style={{marginTop:'-3px'}}>Video Title</p>
                         </div>
                         <div style={{display: 'flex', listStyleType: 'none', marginBottom: '10px'}}>
                            <FontAwesomeIcon icon={faVideo} style={{color:'green', marginRight:'10px'}}/><p style={{marginTop:'-3px'}}>Video Title</p>
                         </div>
